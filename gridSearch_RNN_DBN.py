...
params['STEP4']['hidden_recurrent'] = [800]
...
params['STEP4']['finetune'] = {
    'batch_size' : [10,30,50],
    'learning_rate' : [0.0001,0.0005,0.001,0.003,0.007],
    'epochs' : [200]
}
...
def msg_loop(stdscr):
    ...
    if x == 3:
        while True:
            ...
            msg += '0:SVC 1: SdA_regression, 2: DBN, 3: SdA_RNN, 4:RNNRBM_MLP, 5:RNNRBM_DBN 6:DBN_RNNRBM\n'
            stdscr.addstr(msg)
            m = int(stdscr.getstr())
            curses.flushinp()
            stdscr.clear()
