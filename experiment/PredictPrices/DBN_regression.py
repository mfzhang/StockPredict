...
def pretrain(dataset=None, shared_dataset=None, hidden_layers_sizes=[1000,1000,1000], k=1,
...
def finetune(dataset=None, model=None, shared_dataset=None,
...
def train_DBN(dataset=None, hidden_layers_sizes=[1000,1000,1000], k=1,
             pretrain_lr=0.01, pretrain_batch_size=20, pretrain_epochs=20,
             finetune_lr=0.1, finetune_batch_size=10, finetune_epochs=100):
    """
    Demonstrates how to train and test a Deep Belief Network.
    ...
    print '... building the model'
    # construct the Deep Belief Network
    dbn = DBN(numpy_rng=numpy_rng, n_ins=train_set_x.get_value().shape[1],
              hidden_layers_sizes=hidden_layers_sizes,
              n_outs=1)
    ...
    end_time = time.clock()
    print dbn.get_prediction([test_set_x.eval()[0]])
