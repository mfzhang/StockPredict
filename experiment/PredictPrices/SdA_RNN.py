...
def pretrain_SdA(dataset=None, outdir=None, hidden_layers_sizes=[1000, 1000, 1000], corruption_levels = [.1, .2, .3],
    ...
    sda = SdA(numpy_rng=numpy_rng, n_ins=dataset.phase2_input_size,
...
def finetune_SdA(dataset=None, sda=None, finetune_lr=0.1, finetune_batch_size=10, finetune_epochs=100):
    ...
    print test_score
    # pdb.set_trace()
    return sda, best_validation_loss, test_score
...
def train_SdA(dataset=None, outdir=None, hidden_layers_sizes=[1000, 1000, 1000], corruption_levels = [.3, .3, .3],
    ...
    if outdir != None:
        ...
        f_out.write(cPickle.dumps(sda, 1))
        f_out.close()
    ########################
    # FINETUNING THE MODEL #
    ########################
