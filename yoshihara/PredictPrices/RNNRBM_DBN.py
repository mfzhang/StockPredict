...
class RNNRBM_DBN(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, n_ins=784,
                hidden_layers_sizes=[500,500], hidden_recurrent=150, n_outs=1):
            self.sigmoid_layers = []
            self.rnnrbm_layers = []
            self.rbm_layers= []
            self.params = []
...
def train_rnnrbm_dbn(dataset=None, hidden_layers_sizes=[500], hidden_recurrent=150, k=1,
    ...
    rnnrbm_dbn = RNNRBM_DBN(numpy_rng=numpy_rng, n_ins=dataset.phase2_input_size,
    ...
    pretraining_fns,pretraining_f_bh_t = rnnrbm_dbn.pretraining_functions(train_set_x=train_set_x,
                                                batch_size=pretrain_batch_size,k=k)
    print '... pre-training the model'
    start_time = time.clock()
    ## Pre-train layer-wise
    for i in xrange(rnnrbm_dbn.n_layers):
    ...
    train_fn, validate_model, test_model = rnnrbm_dbn.build_finetune_functions(
