...
class MLP(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, n_ins=784,
                 hidden_layers_sizes=[500], n_outs=1):
     	    self.sigmoid_layers = []
            self.params = []
...
def train_mlp(dataset=None, hidden_layers_sizes=[500],
    ...
    mlp =MLP(numpy_rng=numpy_rng, n_ins=dataset.phase2_input_size,
    ...
    end_time = time.clock()
    print mlp.get_prediction([test_set_x.eval()[0]])
