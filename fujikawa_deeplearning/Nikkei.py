...
wordidset_all = "a"
wordidset_chi2_selected = "dataset/chi2.wordidset"

##  株価 / 辞書データに関するディレクトリ  
pricelistdir = 'dataset/pricelist.pkl'
dicdir = 'dataset/threshold100_-kigou-joshi-jodoushi-namedentity_heuristics.dic'
...
class Nikkei():
    def __init__(self, type="theano_sparse", dataset_type='chi2_selected', brandcode ='0101'):
        ...
        self.train_years = [1999, 2000, 2001, 2002, 2003, 2004]
        self.valid_years = [2005, 2006]
        self.test_years = [2007, 2008]
                ...
                if year in self.pricelist[brandcode]:
                    ...
                    for date in pricelist_datelist:
                        if date in dataset[year]:
                            ...
                            rate = self.pricelist[brandcode][year][date]['closing_price'] - self.pricelist[brandcode][year][date]['opening_price']
